...
/*   Updated: 2024/08/29 15:47:42 by mtalbi           ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */

#include "philo_bonus.h"

t_philo	*add_chair(int id, char **argv, t_allocate **head)
{
	t_philo	*philo;
...
int	add_philo(t_philo **philos, int id, char **argv, t_allocate **head)
{
	t_philo	*current;
